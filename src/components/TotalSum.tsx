...
export default function TotalSum() {
  ...
  return (
    <section className='border border-primary h-fit p-10 rounded-xl shadow-md shadow-foreground/25 flex-grow flex flex-col gap-5 mb-20'>
      ...
      <ScrollArea className='max-h-96'>
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead>Product x Quantity</TableHead>
      ...
      <Button
        className='w-full text-base md:text-lg xl:text-xl 2xl:text-2xl font-medium h-fit py-2'
